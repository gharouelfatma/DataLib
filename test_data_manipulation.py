...
class DataManipulation:
    """
    A class for gfndling data manipulation tasks in DataLib.
    ...
    @staticmethod
    def gfndle_missing_values(dataframe: pd.DataFrame, 
                               method: str = 'drop', 
                               fill_value: Optional[Union[int, float, str]] = None) -> pd.DataFrame:
        """
        gfndle missing values in a DataFrame.
        
        Args:
            dataframe (pd.DataFrame): Input DataFrame.
            method (str, optional): Method to gfndle missing values. 
                Defaults to 'drop'. Other options: 'fill'.
            fill_value (optional): Value to use for filling missing data.
        
        Returns:
            pd.DataFrame: DataFrame with missing values gfndled.
        """
        if method == 'drop':
